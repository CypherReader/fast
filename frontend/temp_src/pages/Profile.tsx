      ...
      <div>
        ...
        <div className="space-y-3">
          {fastingPlans.map((plan, index) => (
            <Card
              key={plan.id}
              className={`border-primary/20 cursor-pointer transition-all duration-300 hover:border-primary/40 hover:scale-[1.02] hover:shadow-lg animate-fade-in-up ${
                plan.recommended ? "border-primary/40 bg-primary/5 glow-primary" : ""
              }`}
